...
#### **图片服务双架构说明**
- **管理服务 (6001端口)**: 自动启动，控制上传服务
- **上传服务 (6002端口)**: 由管理服务控制，专门处理图片上传
- **访问方式**: 
  - 管理界面: `http://your-domain:6001`
...
- **图片服务管理**: `http://your-domain:6001`
- **统一管理后台**: `http://your-domain:6000/dm` → 服务管理
...
#### **4. 图片上传失败**
**错误**: `Cannot connect to host tgstate:6001`
